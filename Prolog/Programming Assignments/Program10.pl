...
lifespan(salman_bin_abdulaziz_al_saud, 1935, alive).
lifespan(faisal_bin_salman, 1970, alive).
lifespan(mohammed_bin_salman, 1940, alive).
lifespan(sultan_bin_salman_al_saud, 1956, alive).
lifespan(saud_bin_faisal_al_saud, 1940, 2015).
lifespan(khaled_bin_faisal_al_saud, 1940, alive).
lifespan(mohammed_bin_fahd_al_saud, 1950, alive).
lifespan(miteb_bin_abdullah_al_saud, 1952, alive).
lifespan(sultan_bin_abdulaziz_al_saud, 1928, 2011).
lifespan(khaled_bin_sultan_al_saud, 1949, alive).
lifespan(bandar_bin_sultan_al_Saud, 1949, alive).
lifespan(mohammed_bin_fahd_al_saud, 1950, alive).
lifespan(talal_bin_abdulaziz_al_saud, 1931, 2018).
lifespan(alwaleed_bin_talal_al_saud, 1955, alive).
lifespan(nayef_bin_abdulaziz_al_saud, 1934, 2012).
lifespan(saud_bin_nayef_al_saud, 1956, alive).
lifespan(mohammed_bin_nayef_al_saud, 1959, alive).
